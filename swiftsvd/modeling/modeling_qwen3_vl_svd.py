...
# ============================================================================
# TEXT/LLM COMPONENTS (MODIFIED WITH SVD COMPRESSION)
# ============================================================================
...
class Qwen3VLTextAttention_SVD(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper with low-rank + sparse approximation"""
    ...
    def __init__(self, config: Qwen3VLTextConfig, layer_idx: int):
        ...
        # Get compression parameters for each projection
        ...
        # Low-rank + sparse factorized projections
...
class Qwen3VLTextMLP_SVD(nn.Module):
...
class Qwen3VLTextDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3VLTextConfig, layer_idx: int):
        ...
        # Use SVD-compressed attention and MLP for text decoder
        self.self_attn = Qwen3VLTextAttention_SVD(config=config, layer_idx=layer_idx)
        self.mlp = Qwen3VLTextMLP_SVD(config, layer_idx=layer_idx)
...
class Qwen3VLTextModel(Qwen3VLPreTrainedModel):
    ...
    def __init__(self, config: Qwen3VLTextConfig, compression_path: str = ""):
        # Load compression ratios if provided
        if compression_path != "":
            import json
...
class Qwen3VLModel(Qwen3VLPreTrainedModel):
    ...
    def __init__(self, config, compression_path: str = ""):
        super().__init__(config)
        self.visual = Qwen3VLVisionModel._from_config(config.vision_config)
        # Pass compression_path to text model for SVD compression
        self.language_model = Qwen3VLTextModel._from_config(config.text_config, compression_path=compression_path)
...
class Qwen3VLForConditionalGenerationSVD(Qwen3VLPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config, compression_path: str = ""):
        super().__init__(config)
        # Pass compression_path to the model for SVD compression of LLM part
        self.model = Qwen3VLModel(config, compression_path=compression_path)
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoProcessor, Qwen3VLForConditionalGenerationSVD

        >>> model = Qwen3VLForConditionalGenerationSVD.from_pretrained("Qwen/Qwen3-VL-8B-Instruct")
...
__all__ = [
    "Qwen3VLVisionModel",
    "Qwen3VLForConditionalGenerationSVD",
    "Qwen3VLModel",
